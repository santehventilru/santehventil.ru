...
import MobailDropList from "./ModailDropList"
...
export default function MobailHeader({handelCart}:{handelCart:() => void}){
    ...
    return <>
        ...
        {/* <div className="menu-down-nav">

            <a id="CatalogDown" className="nav-text drop-button-down">Каталог</a>

            <a href="/shippingInformation" className="nav-text">Доставка</a>

            <a href="/brand" className="nav-text">Бренды</a>

            <a href="/contats" className="nav-text">Контакты</a> 
            
        </div>

        <div className="menu-down-category">

             <a href="/product/heating" className="catalog-list--item-down">Отопление</a>

            <a href="/product/heating" className="catalog-list--item-down">Сантехника</a>

            <a href="/product/heating" className="catalog-list--item-down">Инструменты</a>

            <a href="/product/heating" className="catalog-list--item-down">Для дачи и сада</a> 
