...
import LiHeaderNav from '../../ui-ux/NavCp/LiHeaderNav'
import { useDispatch, useSelector } from 'react-redux'
import {setOpenLogin, setCloseModals} from '../../../redux_tollkit/slices/logRegSlice/loginRegSlice'
        ...
        <div className="wp-logo" >
                ...
                <ul className="wp-nav">
                    <li className="haeder-burger" onClick={handelClick2}>
                        <svg height="20" width="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" className="svg-burger"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    ...
                    {liNav.map((item) => (<LiHeaderNav key={item.text} {...item}/>))}
                </ul>
