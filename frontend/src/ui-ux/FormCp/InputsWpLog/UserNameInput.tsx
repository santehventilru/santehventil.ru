...
export default function UserNameInput(){
    ...
    return <label className="relative" htmlFor="Login">
        <svg  className ="svg-login-group"  viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <input ref={input} type="text" name="Login" id="Login" className="input-entry-login no-color-input" placeholder="Login" required  minLength={4}/>
</label>
}