...
import InnerCardNav from "../NavCp/InnerCardNav";
...
const  PorductCard =  React.memo(({product_id, name, price, main_image, sku, disc, final_price, typesCard, productpath}:ProductCard) => {
    ...
    return <article className={clsx(`cart-wrapper cart-wrapper-catalog wp-sale`,{
            [hitsClass]: styleCard === 'hits'
                ...
                <div className="cart catalog-cart">
                    <InnerCardNav product_id={product_id} url={`productpage/${product_id}/${nameEn}/${productPath}`}/>
                               ...
                               {isFav &&  
                                ...
                                style={{
                                    ...
                                    <svg width="21" height="18" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M10 17C9.74374 17 9.49669 16.9072 9.30415 16.7388C8.577 16.1035 7.87593 15.5065 7.2574 14.9799L7.25424 14.9772C5.44081 13.4332 3.87485 12.0998 2.78528 10.7863C1.56731 9.31791 1 7.92567 1 6.40473C1 4.92701 1.50716 3.56372 2.42795 2.56581C3.35973 1.5561 4.63826 1 6.02844 1C7.06747 1 8.01903 1.3282 8.8566 1.97541C9.2793 2.3021 9.66245 2.70192 10 3.16828C10.3377 2.70192 10.7207 2.3021 11.1435 1.97541C11.9811 1.3282 12.9327 0.999999 13.9717 0.999999C15.3617 0.999999 16.6404 1.5561 17.5722 2.56581C18.493 3.56371 19 4.92701 19 6.40473C19 7.92567 18.4328 9.31791 17.2149 10.7862C16.1253 12.0998 14.5595 13.433 12.7463 14.9769C12.1267 15.5043 11.4245 16.1023 10.6957 16.739C10.5033 16.9072 10.2561 17 10 17ZM6.02844 2.05348C4.93626 2.05348 6.7299 8.20914 6 9C5.25925 9.8028 2.05428 5.19236 2.05428 6.40473C2.05428 7.68391 2.53012 8.82794 3.59703 10.1141C4.62824 11.3574 6.16206 12.6633 7.938 14.1755L7.9413 14.1782C8.56216 14.7069 9.5 12 10 13C10.5 12 11.4403 14.7047 12.0624 14.1752C13.8382 12.663 15.3719 11.3574 16.4031 10.1141C17.4699 8.82794 17.9457 7.68391 17.9457 6.40473C17.9457 5.19236 14.7408 9.8028 14 9C13.2702 8.20914 15.0637 2.05348 13.9717 2.05348C13.1716 2.05348 12.6486 5.49892 12 6C11.422 6.44675 10.8078 3.82016 10.5717 4.21531C10.4503 4.41852 10.2366 10.1141 10 10.1141C9.76338 10.1141 9.5497 4.41852 9.4283 4.21531C9.19237 3.82016 8.57816 6.44675 8 6C7.35139 5.49892 6.82838 2.05348 6.02844 2.05348Z" fill="#7880B5"/>
                                    </svg>
                    ...
                    <Link to={`/productpage/${product_id}/${nameEn}/${productPath}`} className="wrapper-tover--ref">
