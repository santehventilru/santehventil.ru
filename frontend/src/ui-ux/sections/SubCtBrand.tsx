...
import BrandDescrBlock from "../Cards/BrandDescrInfo";
import SbCatItem from "../filtersCp/FilterSbCatItem";

export interface BrandSubCatInterface{
            ...
            <div className="container container-ferst-mobail">
                <div style={{display:"flex", alignItems:"center", flexWrap:'wrap'}}>
                    <button onClick={() => navigate(-1)} style={{paddingLeft:10}}>
                        <svg style={{height:30, width:30}} fill="#c0c0c0" height="200px" width="200px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 512 512"  stroke="#c0c0c0">
