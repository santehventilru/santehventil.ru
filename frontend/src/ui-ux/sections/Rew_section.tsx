...
import { RewCardInterface } from "../../types/interface"
import { useLocation, useParams } from "react-router-dom"
import RewCard from "../Cards/RewCard"
...
export function RewAdd({closeModal, setRewAdd}:{closeModal:() => void, setRewAdd:(item:boolean) => void}){
    ...
    // const login = Array.isArray(userInfo)
    //     ? userInfo.reduce<Record<string, any>>((acc, item:{key:string, value:string}) => {
