...
import {setOpenRegister, setCloseModals} from '@toolkit/slices/logRegSlice/loginRegSlice'
import svgCross from '../assets/SvgCross.svg'
    ...
    return <div className="wraper-modal-entry">
                        ...
                        <form className="form-entry">
                                ...
                                <label className="relative" htmlFor="Password">
                                    ...
                                    <PasswordTumbler handlePass={() => handlePass()} typePassword={pass}/>
                                        
                                    <input type={pass} name="password" id="Password" onBlur={() => handelFocus(false)} onFocus={() => handelFocus('password')} className="input-entry-password no-color-input" value={formData.password} placeholder="Password" required  minLength={4} onChange={handleChange}/>
                                </label>
