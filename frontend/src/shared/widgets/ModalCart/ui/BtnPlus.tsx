...
export default function BtnPlus({quantity, changeQuant}:{quantity:number, changeQuant:(newQuant: number) => void}){
    ...
    return  <button className='item-basket-plus' onClick={handelClick}>
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#e3e3e3" className='svg-basket-pop-plus'>
