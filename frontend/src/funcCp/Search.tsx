...
export default function SearchPage(){
    ...
    const [fesrt, setFerst] = useState<ProductCard[]>([])
    const [second, setSecond] = useState<ProductCard[]>([])
